    ...
    <footer className="bg-[#1A1A1A] text-zinc-300 font-['Poppins'] pt-20 pb-8 border-t border-[#8B5A2B]/20">
      <div className="max-w-7xl mx-auto px-6 md:px-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          >
            ...
            <p className="text-zinc-400 mb-8 max-w-sm leading-relaxed text-sm">
              Kelompok Mahasiswa KKN Politeknik LP3I Kampus Tasikmalaya 0126 yang berdedikasi membangun dan memberdayakan potensi Desa Cigalontang melalui program inovatif dan berkelanjutan.
            </p>
          ...
          >
            ...
            <ul className="space-y-4 text-sm">
              <li><a href="#home" className="hover:text-[#8B5A2B] transition-colors">Beranda</a></li>
              <li><a href="#tentang-desa" className="hover:text-[#8B5A2B] transition-colors">Profil Desa</a></li>
              <li><a href="#filosofi" className="hover:text-[#8B5A2B] transition-colors">Filosofi Logo</a></li>
              <li><a href="#anggota" className="hover:text-[#8B5A2B] transition-colors">Anggota Tim</a></li>
              <li><a href="#galeri" className="hover:text-[#8B5A2B] transition-colors">Galeri Kegiatan</a></li>
            </ul>
          </motion.div>
          ...
          >
            ...
            <ul className="space-y-4 text-sm">
              ...
              <li className="flex items-center gap-3">
                ...
                <span>halo@kknmengabdi.ac.id</span>
              </li>
            </ul>
          </motion.div>
        ...
        <motion.div 
          ...
          className="pt-8 border-t border-white/10 flex flex-col md:flex-row items-center justify-between gap-4 text-xs text-zinc-500"
        >
          <p>&copy; 2026 KKN Politeknik LP3I Kampus Tasikmalaya 0126. All rights reserved.</p>
          <div className="flex items-center gap-6">
            <a href="#" className="hover:text-white transition-colors">Dikembangkan Oleh TIM KKN LP3I TASIK</a>
