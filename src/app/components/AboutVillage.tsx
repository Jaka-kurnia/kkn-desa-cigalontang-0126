...
import aboutImg from "./img/pangangonan.jpg";
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <motion.div initial={{ opacity: 0, x: -30 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true, margin: "-100px" }} transition={{ duration: 0.7 }} className="order-2 lg:order-1">
            ...
            <p className="text-[#555555] mb-10 leading-relaxed">Melalui program KKN ini, kami berfokus pada pengembangan Teknologi, UMKM lokal, digitalisasi desa, dan pendidikan anak-anak untuk mendukung kemajuan Cigalontang tanpa menghilangkan nilai-nilai kearifan lokal.</p>
          ...
          <motion.div initial={{ opacity: 0, x: 30 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true, margin: "-100px" }} transition={{ duration: 0.7, delay: 0.2 }} className="order-1 lg:order-2 relative">
            ...
            <div className="relative h-[500px] rounded-3xl overflow-hidden shadow-[0_20px_50px_rgba(0,0,0,0.1)]">
              <ImageWithFallback src={aboutImg} alt="Keindahan alam sawah di Desa Cigalontang saat matahari terbit" className="w-full h-full object-cover" />
            </div>
          </motion.div>
        </div>
      </div>
